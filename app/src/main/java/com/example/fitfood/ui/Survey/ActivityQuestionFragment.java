...
public class ActivityQuestionFragment extends Fragment {
    FragmentActivityQuestionBinding binding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.activityLvl.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                binding.nextBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        userViewModel.my_user.ActivityLevel = selectedRadioButton.getText().toString();
                        navController.navigate(R.id.action_activityQuestionFragment_to_trainingFrequencyQuestionFragment);
                    }
                });
            }
        });
